...
import { harvestPosition, plantPosition, settleMatureCrops, trainPosition } from './lib/farmActions';
...
import { PlantTraining } from './components/PlantTraining';
...
export default function App() {
  ...
  const trainPlant = (id: string, training: import('./types').PlantTraining) => setState(current => trainPosition(current, id, training, Date.now()));
  const context = { trainPlant, state, now, go, equipFarmer, setAutoHarvest, activateNft, mintAccess, buyPlot, openPosition, careForPosition, closePosition, fulfillOrder, contributeCrew, claimCrewReward, completePractice };
  let page: ReactNode;
  if (positionMatch) {
...
export type ViewContext = {
  trainPlant: (id: string, training: import('./types').PlantTraining) => void;
